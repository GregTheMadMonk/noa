...
/**
 * \brief A common base class for \ref TridiagonalMatrix and \ref TridiagonalMatrixView.
 *
...
class TridiagonalMatrixBase : public MatrixBase< Real, Device, Index, GeneralMatrix, Organization >
{
...
public:
    ...
    */
   __cuda_callable__
   TridiagonalMatrixBase( typename Base::ValuesViewType values, IndexerType indexer );

   /**
    * \brief Copy constructor.
    */
   __cuda_callable__
   TridiagonalMatrixBase( const TridiagonalMatrixBase& ) = default;

   /**
    * \brief Move constructor.
    */
   __cuda_callable__
   TridiagonalMatrixBase( TridiagonalMatrixBase&& ) noexcept = default;
   ...
   operator=( const TridiagonalMatrixBase& ) = delete;

   /**
    * \brief Move-assignment operator.
    */
   TridiagonalMatrixBase&
   operator=( TridiagonalMatrixBase&& ) = delete;
   ...
   [[nodiscard]] bool
   operator==( const TridiagonalMatrixBase< Real_, Device_, Index_, Organization_ >& matrix ) const;
    ...
    *
    * \par Example
    * \include Matrices/TridiagonalMatrix/TridiagonalMatrixViewExample_forElements.cpp
    * \par Output
    ...
    * \ref TridiagonalMatrixBase::forElements where more than one thread can be mapped to each row.
    *
    ...
    * ```
    *
    * \e RowView represents matrix row - see \ref noa::TNL::Matrices::TridiagonalMatrixBase::RowView.
    *
    * \par Example
    ...
    * ```
    *
    * \e ConstRowView represents matrix row - see \ref noa::TNL::Matrices::TridiagonalMatrixBase::ConstRowView.
    */
   template< typename Function >
   void
    ...
    *
    * In each row, given lambda function is performed. Each row is processed by at most one thread unlike the method
    * \ref TridiagonalMatrixBase::forAllElements where more than one thread can be mapped to each row.
    *
    * \tparam Function is type of the lambda function.
    *
    * \param function is an instance of the lambda function to be called for each row.
    ...
    *
    * See \ref TridiagonalMatrixBase::sequentialForRows.
    *
    * \tparam Function is a type of lambda function that will operate on matrix elements.
    * \param function  is an instance of the lambda function to be called in each row.
    */
    ...
    *
    * See \ref TridiagonalMatrixBase::sequentialForAllRows.
    *
    * \tparam Function is a type of lambda function that will operate on matrix elements.
    * \param function  is an instance of the lambda function to be called in each row.
    */
...
protected:
   ...
   __cuda_callable__
   void
   bind( typename Base::ValuesViewType values, IndexerType indexer );
};
...
template< typename Real, typename Device, typename Index, ElementsOrganization Organization >
std::ostream&
operator<<( std::ostream& str, const TridiagonalMatrixBase< Real, Device, Index, Organization >& matrix )
{
   matrix.print( str );
   return str;
}
