...
public:
    ...
    * ```
    *
    * \e RowView represents matrix row - see \ref noa::TNL::Matrices::MultidiagonalMatrixBase::RowView.
    *
    * \par Example
    ...
    * ```
    *
    * \e ConstRowView represents matrix row - see \ref noa::TNL::Matrices::MultidiagonalMatrixBase::ConstRowView.
    */
   template< typename Function >
   void
