...
public:
    ...
    * ```
    *
    * \e ConstRowView represents matrix row - see \ref noa::TNL::Matrices::DenseMatrixBase::ConstRowView.
    */
   template< typename Function >
   void
    ...
    * ```
    *
    * \e RowView represents matrix row - see \ref noa::TNL::Matrices::DenseMatrixBase::RowView.
    *
    * \par Example
    * \include Matrices/DenseMatrix/DenseMatrixViewExample_forRows.cpp
    * \par Output
