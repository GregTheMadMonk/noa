...
#include <noa/3rdparty/tnl-noa/src/TNL/Algorithms/Segments/printSegments.h>
#include <noa/3rdparty/tnl-noa/src/TNL/Algorithms/SegmentsReductionKernels/detail/CheckLambdas.h>
