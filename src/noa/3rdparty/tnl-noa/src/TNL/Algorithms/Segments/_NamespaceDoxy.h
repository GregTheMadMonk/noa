...
We demonstrate two formats of segments - \ref noa::TNL::Algorithms::Segments::CSR and \ref noa::TNL::Algorithms::Segments::Ellpack running
...
Next we use a function \ref noa::TNL::Algorithms::Segments::printSegments to print the content of the segments (lines 38-39). To do
...
means of the method \ref noa::TNL::Algorithms::Segments::CSR::getSegmentsCount (and \ref
TNL::Algorithms::Segments::Ellpack::getSegmentsCount respectively). The sums are computed using the method \ref
TNL::Algorithms::Segments::CSR::reduceAllSegments (and \ref noa::TNL::Algorithms::Segments::Ellpack::reduceAllSegments respectively)
which works the same way as the flexible parallel reduction (\ref noa::TNL::Algorithms::reduce). It requires lambda functions
