...
struct ChunkedEllpackKernel
{
   using IndexType = Index;
   using DeviceType = Device;
   using ViewType = ChunkedEllpackKernel< Index, Device >;
   using ConstViewType = ChunkedEllpackKernel< Index, Device >;
...
#include "ChunkedEllpackKernel.hpp"
