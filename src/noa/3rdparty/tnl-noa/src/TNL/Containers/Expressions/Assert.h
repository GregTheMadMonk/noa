...
TNL_IMPL_ALL_CMP_HELPER_( ALL_GT, greater, > )
   ...
   #define TNL_ASSERT_ALL_LE( val1, val2, msg ) __TNL_ASSERT_PRED2( ::noa::TNL::Assert::cmpHelperALL_LE, <=, val1, val2, msg )
   #define TNL_ASSERT_ALL_LT( val1, val2, msg ) __TNL_ASSERT_PRED2( ::noa::TNL::Assert::cmpHelperALL_LT, <, val1, val2, msg )
   #define TNL_ASSERT_ALL_GE( val1, val2, msg ) __TNL_ASSERT_PRED2( ::noa::TNL::Assert::cmpHelperALL_GE, >=, val1, val2, msg )
   #define TNL_ASSERT_ALL_GT( val1, val2, msg ) __TNL_ASSERT_PRED2( ::noa::TNL::Assert::cmpHelperALL_GT, >, val1, val2, msg )
