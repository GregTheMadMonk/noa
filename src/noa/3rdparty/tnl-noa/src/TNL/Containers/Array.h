 ...
 *                   is selected with \ref noa::TNL::Allocators::Default.
 *
...
public:
    ...
    * \ref noa::TNL::Containers::Array "Array" type with changed template
    * parameters.
    */
...
protected:
    ...
    * the two overloads of \ref noa::TNL::Containers::Array::resize "resize".
    */
   void
