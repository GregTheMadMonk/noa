...
struct CuthillMcKeeOrdering
{
   ...
   {
      static_assert( std::is_same_v< typename Mesh::DeviceType, noa::TNL::Devices::Host > );
      static_assert( std::is_same_v< typename PermutationArray::DeviceType, noa::TNL::Devices::Host > );
